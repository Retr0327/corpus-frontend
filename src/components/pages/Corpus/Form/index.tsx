...
import FormController from '@components/common/form';
import { zodResolver } from '@hookform/resolvers/zod';
import { useForm, FormProvider } from 'react-hook-form';
import { Paper, Button, Grid, Group } from '@mantine/core';
import SelectItem from '@components/common/form/components/utils/select';
...
function CorpusForm(props: Props) {
  const { boards } = props;
  ...
  const onSubmit = methods.handleSubmit((data) => {
    ...
    const pushUrl = `${Route.concordance}?pos=false&e=${e}`;
    router.push(pushUrl);
  });
